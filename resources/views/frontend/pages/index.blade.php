...
<head>
    ...
    <title>Martfury - Multipurpose Marketplace HTML5 Template</title>
...
<body>
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                <li class="menu-item-has-children"><a href="index-2.html">Home</a><span class="sub-toggle"></span>
                    <ul class="sub-menu">
                        <li><a href="index-2.html">Marketplace Full Width</a>
                        </li>
    ...
    <div id="homepage-5">
        <div class="ps-home-banner">
            <div class="container">
                ...
                <div class="ps-section__center">
                    <div class="ps-carousel--dots owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on"><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/1.jpg') }}" alt=""></a><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/2.jpg') }}" alt=""></a><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/3.jpg') }}" alt=""></a></div><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-6.jpg') }}" alt=""></a>
                </div>
                <div class="ps-section__right"><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-1.jpg') }}" alt=""></a><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-2.jpg') }}" alt=""></a><a class="wide" href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-3.jpg') }}" alt=""></a><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-4.jpg') }}" alt=""></a><a href="#"><img src="{{ asset('Frontend/img/slider/home-5/promotion-5.jpg') }}" alt=""></a></div>
            </div>
        </div>
                        ...
                        <div class="ps-tabs">
                            <div class="ps-tabs">
                                <div class="ps-tab active" id="tab-1">
                                    <div class="ps-block__item"><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/1.jpg') }}" alt="#television"><span>#television</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/2.jpg') }}" alt="#camera"><span>#camera</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/3.jpg') }}" alt="#watch"><span>#watch</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/4.jpg') }}" alt="#chair"><span>#chair</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/5.jpg') }}" alt="#sneaker"><span>#sneaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/6.jpg') }}" alt="#xbox"><span>#xbox</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/7.jpg') }}" alt="#gopro"><span>#gopro</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/8.jpg') }}" alt="#lipstick"><span>#lipstick</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/9.jpg') }}" alt="#phone"><span>#phone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/10.jpg') }}" alt="#laptop"><span>#laptop</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/11.jpg') }}" alt="#speaker"><span>#speaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/12.jpg') }}" alt="#book"><span>#book</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/13.jpg') }}" alt="#blender"><span>#blender</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/14.jpg') }}" alt="#bag"><span>#bag</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/15.jpg') }}" alt="#smartphone"><span>#smartphone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/16.jpg') }}" alt="#camping"><span>#camping</span></a>
                                    </div>
                                </div>
                                <div class="ps-tab" id="tab-2">
                                    <div class="ps-block__item"><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/3.jpg') }}" alt="#watch"><span>#watch</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/4.jpg') }}" alt="#chair"><span>#chair</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/5.jpg') }}" alt="#sneaker"><span>#sneaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/6.jpg') }}" alt="#xbox"><span>#xbox</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/7.jpg') }}" alt="#gopro"><span>#gopro</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/8.jpg') }}" alt="#lipstick"><span>#lipstick</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/9.jpg') }}" alt="#phone"><span>#phone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/10.jpg') }}" alt="#laptop"><span>#laptop</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/11.jpg') }}" alt="#speaker"><span>#speaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/12.jpg') }}" alt="#book"><span>#book</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/13.jpg') }}" alt="#blender"><span>#blender</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/14.jpg') }}" alt="#bag"><span>#bag</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/15.jpg') }}" alt="#smartphone"><span>#smartphone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/16.jpg') }}" alt="#camping"><span>#camping</span></a>
                                    </div>
                                </div>
                                <div class="ps-tab" id="tab-3">
                                    <div class="ps-block__item"><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/4.jpg') }}" alt="#chair"><span>#chair</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/5.jpg') }}" alt="#sneaker"><span>#sneaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/6.jpg') }}" alt="#xbox"><span>#xbox</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/7.jpg') }}" alt="#gopro"><span>#gopro</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/8.jpg') }}" alt="#lipstick"><span>#lipstick</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/9.jpg') }}" alt="#phone"><span>#phone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/10.jpg') }}" alt="#laptop"><span>#laptop</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/11.jpg') }}" alt="#speaker"><span>#speaker</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/12.jpg') }}" alt="#book"><span>#book</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/13.jpg') }}" alt="#blender"><span>#blender</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/14.jpg') }}" alt="#bag"><span>#bag</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/15.jpg') }}" alt="#smartphone"><span>#smartphone</span></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/categories/home-5/16.jpg') }}" alt="#camping"><span>#camping</span></a>
                                    </div>
                                </div>
        ...
        <div class="ps-product-box">
            <div class="container">
                <div class="ps-home-promotions"><a href="#"><img src="{{ asset('Frontend/img/promotions/home-5/simple.jpg') }}" alt=""></a></div>
                <div class="ps-block--product-box">
                    ...
                    <div class="ps-block__content">
                        <div class="ps-block__left">
                            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on"><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/electronic-1.jpg') }}" alt=""></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/electronic-2.jpg') }}" alt=""></a></div>
                        ...
                        <div class="ps-block__right">
                            <figure>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/electronic/2.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Xbox One Wireless Controller Black Color</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/electronic/3.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Sound Intone I65 Earphone White Version</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/electronic/4.jpg') }}img/products/electronic/4.jpg" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Samsung Gear VR Virtual Reality Headset</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/electronic/5.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Samsung UHD TV 24inch</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                ...
                <div class="ps-block--product-box">
                    ...
                    <div class="ps-block__content">
                        <div class="ps-block__left">
                            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on"><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/clothing-2.jpg') }}" alt=""></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/clothing-1.jpg') }}" alt=""></a></div>
                            <div class="ps-block__products ps-tab-root">
                                <ul class="ps-tab-list">
                                    <li class="current"><a href="#product-box-1">New Arrivals</a></li>
                                    <li><a href="#product-box-2">Best Seller</a></li>
                        ...
                        <div class="ps-block__right">
                            <figure>
                                <figcaption>Recommended For You</figcaption>
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/clothing/1.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Herschel Leather Duffle Bag In Brown Color</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/clothing/3.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Rayban Rounded Sunglass Brown Color</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/clothing/4.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Sleeve Linen Blend Caro Pane Shirt</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/clothing/5.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Men’s Sports Runnning Swim Board Shorts</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                ...
                <div class="ps-block--product-box">
                    ...
                    <div class="ps-block__content">
                        <div class="ps-block__left">
                            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on"><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/kitchen-2.jpg') }}" alt=""></a><a href="shop-default.html"><img src="{{ asset('Frontend/img/promotions/home-5/kitchen-1.jpg') }}" alt=""></a></div>
                            <div class="ps-block__products ps-tab-root">
                                <ul class="ps-tab-list">
                                    <li class="current"><a href="#product-box-1">New Arrivals</a></li>
                                    <li><a href="#product-box-2">Best Seller</a></li>
                        ...
                        <div class="ps-block__right">
                            <figure>
                                <figcaption>Recommended For You</figcaption>
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/home/1.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Korea Long Sofa Fabric In Blue Navy Color</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/home/2.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Aroma Rice Cooker</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/home/3.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Simple Plastice Chair In White Color</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/home/4.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Korea Fabric Chair In Brown Colorr</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
                                ...
                                <div class="ps-product--horizontal">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('Frontend/img/products/home/5.jpg') }}" alt=""></a></div>
                                    <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Set 14-Piece Knife From KichiKit</a>
                                        <div class="ps-product__rating">
                                            <select class="ps-rating" data-read-only="true">
                                                <option value="1">1</option>
